...
function initReliableSignaler(connection, socketObj) {
    ...
    return {
        ...
        getRoomFromServer: function(data, callback) {
            if(data.userId === undefined){
                alert('You need to login first');
                return;
            }
            connection.userid = data.userId || getRandomString();
            socket.emit('get-session-info', data, callback);
        }
    };
}
